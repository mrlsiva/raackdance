      ...
      <div class="loader"></div>
		<div id="home">
			<div class="video-bgimage video-section bgimage-property">
				<div class="pattern-overlay video-padding">	<a id="bgndVideo" class="player" data-property="{videoURL:'https://www.youtube.com/watch?v=dSOxK8VMLwc',containment:'.video-section', quality:'large', autoPlay:true, mute:true, opacity:1}"></a>
					<div class="container">
						<div class="col-sm-12 col-md-12 col-lg-8">
							<div class="header-div">
								<div class="event-book-header">
								 <h1 style="letter-spacing: 2px; padding-top: 200px;" class="text-white">LITTLE<SPAN class="font-weight400 text-white">LEGENDS</span></h1>
							  </div>
							</div>
						</div>
					</div>
      ...
      <section class="section-space event-gallery-show section-white-bg animate-scroll" data-animate="animate__animated animate__fadeInUp">
         <div class="container">
            <div class="section-heading">
               <div>
                  <p class="section-padding-bottom justify">Unleash your child's inner rhythm and watch them twirl, swirl, and shine with joy. Learning and expression come together through our story-based choreography sessions. Through dance, children develop their five senses, enhancing learning abilities and gaining a deeper understanding of movement's meaning. Give your tiny tots the opportunity to explore the world in a whole new way through dance. Age: 03 - 06 Years</p>
				  <div class="text-center">
					<img src="{{asset('/resources/images-raack/courses/client-logo-5.png') }}" alt="Dance classes in Thoraipakkam" style="height:180px; margin: 0 auto;" class="img-fluid text-center">
					</div>
               </div>
            </div>
         </div>
					 ...
					 <div id="yt-shorts" class="owl-carousel owl-theme ">
					   <div class="item text-center">
						  <iframe class="yt-shorts-frame"
							 width="100%"
							 height="100%"
							 src="https://www.youtube.com/embed/PPVhTnvB-k8"
					   ...
					   <div class="item text-center">
						   <iframe class="yt-shorts-frame"
							 width="100%"
							 height="100%"
							 src="https://www.youtube.com/embed/YmrlaaTzaZY"
							 title="YouTube video player"
							 frameborder="0"
							 allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
							 allowfullscreen>
					   ...
					   <div class="item text-center">
						   <iframe class="yt-shorts-frame"
							 width="100%"
							 height="100%"
							 src="https://www.youtube.com/embed/xfKMJ4IPTcI"
							 title="YouTube video player"
							 frameborder="0"
							 allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
							 allowfullscreen>
                  ...
                  <div class="row rowsafari align-items-center" style="margin-top: 30px;">
                     <div class="col-lg-5 col-6 col-sm-6 col-md-6">
                        <div style="display: flex; align-items: center; margin-bottom: 5px;">
                           <img src="{{asset('/resources/images-raack/dance-studios-in-chennai.png') }}" alt="phone" class="img-fluid" style="width: 24px; height: 24px; margin-right: 10px;">
                           <h6>Phone</h6>
                        </div>
