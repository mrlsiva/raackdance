 ...
 <!--=============================== VIDEO AREA START =======================-->
      ...
      <div class="loader"></div>
		<div id="home">
			<div class="video-bgimage video-section bgimage-property">
				<div class="pattern-overlay video-padding">	<a id="bgndVideo" class="player" data-property="{videoURL:'https://www.youtube.com/watch?v=PwYEDmqutkQ',containment:'.video-section', quality:'large', autoPlay:true, mute:true, opacity:1}"></a>
					<div class="container">
						<div class="col-sm-12 col-md-12 col-lg-8">
							<div class="header-div">
								<div class="event-book-header">
								 <h1 style="letter-spacing: 2px; padding-top: 200px;" class="text-white">CHOREO<SPAN class="font-weight400 text-white">LAB</span></h1>
							  </div>
							</div>
						</div>
					</div>
      ...
      <section class="section-space event-gallery-show section-white-bg animate-scroll" data-animate="animate__animated animate__fadeInUp">
         <div class="container">
            <div class="section-heading">
               <div>
                  <p class="justify section-padding-bottom">Our Choreolab program is designed to unleash your creativity and keep you on your toes. With Dance of the Month, you'll explore street styles, learn a new dance piece every month, and become a dancing chameleon. This is the perfect program for passionate dancers seeking instant gratification. Learn trendy moves from the gurus and start making your own. <br> Age : 07 - 12 years | 13 years & above</p>
				  <div class="text-center">
					<img src="{{asset('/resources/images-raack/courses/client-logo-1.png') }}" alt="Dance classes in Thoraipakkam" style="height:180px; margin: 0 auto;" class="img-fluid text-center">
					</div>
               </div>
            </div>
         </div>
					 ...
					 <div id="yt-shorts" class="owl-carousel owl-theme ">
					   <div class="item text-center">
						  <iframe class="yt-shorts-frame"
							 width="100%"
							 height="100%"
							 src="https://www.youtube.com/embed/_rJB38jz6Rc"
					   ...
					   <div class="item text-center">
						   <iframe class="yt-shorts-frame"
							 width="100%"
							 height="100%"
							 src="https://www.youtube.com/embed/PgkFtdh9UQc?si=ws5P2IBdzrO18qjQ"
							 title="YouTube video player"
							 frameborder="0"
							 allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
							 allowfullscreen>
					   ...
					   <div class="item text-center">
						   <iframe class="yt-shorts-frame"
							 width="100%"
							 height="100%"
							 src="https://www.youtube.com/embed/o87VXsXLpQw"
							 title="YouTube video player"
							 frameborder="0"
							 allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
							 allowfullscreen>
      ...
      <section class="section-space section-white-bg animate-scroll" data-animate="animate__animated animate__fadeInUp">
         <div class="container">
			<div class="section-heading">
               <div class="client-logo-slider">
                  <h1 class="mx-auto theme-color text-center">SIGN UP <span class="font-weight400 text-dark">TODAY</span></h1>
                  <img src="{{asset('/resources/images-raack/114x52.png') }}" alt="Dance classes in old perungalathur" class="img-fluid course-ul-img-right animate-scroll" data-animate="animate__animated animate__zoomIn">
               </div>
            </div>
