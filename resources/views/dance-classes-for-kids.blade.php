      ...
      <div class="loader"></div>
		<div id="home">
			<div class="video-bgimage video-section bgimage-property">
				<div class="pattern-overlay video-padding">	<a id="bgndVideo" class="player" data-property="{videoURL:'https://www.youtube.com/watch?v=SNeyFEZZaI4',containment:'.video-section', quality:'large', autoPlay:true, mute:true, opacity:1}"></a>
					<div class="container">
						<div class="col-sm-12 col-md-12 col-lg-8">
							<div class="header-div">
								<div class="event-book-header">
								 <h1 style="letter-spacing: 2px; padding-top: 200px;" class="text-white">RD<SPAN class="font-weight400 text-white">EP</span></h1>
							  </div>
							</div>
						</div>
					</div>
      ...
      <section class="section-space event-gallery-show section-white-bg animate-scroll" data-animate="animate__animated animate__fadeInUp">
         <div class="container">
            <div class="section-heading">
               <div>
                  <p class="justify section-padding-bottom">The RDEP program is all about self-expression and unlocking your dance potential. With Raack's uniquely curated levels, you'll groove to the rhythm, master body language, and discover the meaning behind every movement. Our copyrighted music and versatile curriculum will take your dancing to the next level. Boost confidence, enhance concentration, and unleash your inner dance superstar with RAACK. Age : 07 - 12 years</p>
				  <div class="text-center">
					<img src="{{asset('/resources/images-raack/courses/client-logo-6.png') }}" alt="Dance classes in Thoraipakkam" style="height:180px; margin: 0 auto;" class="img-fluid text-center">
					</div>
               </div>
            </div>
         </div>
             ...
             <div id="yt-shorts" class="owl-carousel owl-theme ">
               <div class="item text-center">
                 <iframe class="yt-shorts-frame"
                   width="100%"
                   height="100%"
                   src="https://www.youtube.com/embed/it9Zsj5KcyQ"
               ...
               <div class="item text-center">
                  <iframe class="yt-shorts-frame"
                   width="100%"
                   height="100%"
                   src="https://www.youtube.com/embed/37nr0wNzar4"
                   title="YouTube video player"
                   frameborder="0"
                   allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                   allowfullscreen>
               ...
               <div class="item text-center">
                  <iframe class="yt-shorts-frame"
                   width="100%"
                   height="100%"
                   src="https://www.youtube.com/embed/BximtcOaEmY"
                   title="YouTube video player"
                   frameborder="0"
                   allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                   allowfullscreen>
