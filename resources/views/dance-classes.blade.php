						...
						<div class="col-sm-12 col-md-12 col-lg-8">
							<div class="header-div">
								<div class="event-book-header">
								 <h1 style="letter-spacing: 2px; padding-top: 200px;" class="text-white">JUST<SPAN class="font-weight400 text-white">DANCE</span></h1>
							  </div>
							</div>
						</div>
					</div>
      ...
      <section class="section-space event-gallery-show section-white-bg animate-scroll" data-animate="animate__animated animate__fadeInUp">
         <div class="container">
            <div class="section-heading">
               <div>
                  <p class="justify section-padding-bottom">Our Open Class program is designed to quench your dance thirst and help you last through the week. With vibrant choreography workshops, you'll learn the art of concentration through movement and boost your confidence on the dance floor. Repair your body and mind while spending just one hour a week with Raack. Join us for joy-filled dance sessions that fit perfectly into your busy schedule! Age : 07 - 12 years | 13 years & above</p>
				  <div class="text-center">
					<img src="{{asset('/resources/images-raack/courses/client-logo-4.png') }}" alt="Dance classes in Thoraipakkam" style="height:180px; margin: 0 auto;" class="img-fluid text-center">
					</div>
               </div>
            </div>
         </div>
					 ...
					 <div id="yt-shorts" class="owl-carousel owl-theme ">
					   <div class="item text-center">
						  <iframe class="yt-shorts-frame"
							 width="100%"
							 height="100%"
							 src="https://www.youtube.com/embed/aQXcVb_yTK8"
					   ...
					   <div class="item text-center">
						   <iframe class="yt-shorts-frame"
							 width="100%"
							 height="100%"
							 src="https://www.youtube.com/embed/UhVetG6Dae4"
							 title="YouTube video player"
							 frameborder="0"
							 allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
							 allowfullscreen>
					   ...
					   <div class="item text-center">
						   <iframe class="yt-shorts-frame"
							 width="100%"
							 height="100%"
							 src="https://www.youtube.com/embed/usEkcGvD7A8"
							 title="YouTube video player"
							 frameborder="0"
							 allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
							 allowfullscreen>
