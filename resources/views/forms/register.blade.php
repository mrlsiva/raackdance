...
<form id="contactus-form" class="contactus-form" action="{{route('contactusmail.store')}}" method="POST">
	@csrf	
	<input type="hidden" name="form_id" value="002" />
	...
	<div class="form-field {{ $errors->has('course') ? 'has-error' : ''}}">
		<div class="form-textarea-top-spacing">
		   <select name="course" id="course" class="form-input @error('course') is-invalid @enderror" required>
				<option value="" disabled="disabled" selected="true">Competition Categories</option>
				<hr>
				<option value="Little Legends (Ages 03-06)">Little Legends (Ages 03-06)</option>
				<hr>
				<option value="RDEP Level 1 (Ages 07-12)">RDEP Level 1 (Ages 07-12)</option>
				<hr>
				<option value="RDEP Level 2 (Ages 07-12)">RDEP Level 2 (Ages 07-12)</option>
				<hr>
				<option value="Choreo Lab (Ages 07-12)">Choreo Lab (Ages 07-12)</option>
				<hr>
				<option value="Choreo Lab (Ages 13+)">Choreo Lab (Ages 13+)</option>
				<hr>
				<option value="Film Covers (Ages 07-12)">Film Covers (Ages 07-12)</option>
				<hr>
				<option value="Film Covers (Ages 13+)">Film Covers (Ages 13+)</option>
		   </select>
		</div>
	</div>               
