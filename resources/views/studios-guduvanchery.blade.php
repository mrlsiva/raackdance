...
@section('content') 
 ...
 <!--================================= HEADER START ==========================================-->
      <section class="animate-scroll studio-bg-img" data-animate="animate__animated animate__fadeInUp" style="background-image: url({{asset('/resources/images-raack/studio-bg-image/Guduvanchery.png') }}">
		   <div class="container">
			  <div class="text-right">
				 <h1 style="color: #ffffff;" class="font-weight400 rounded-box">GUDUVANCHERY</span></h1>
			  </div>
		   </div>
      </section>
      <!--================================= HEADER END ==========================================-->
			...
			<div class="row">
				<div class="col-lg-7 mx-auto text-center">
					<div class="section-heading">
					   ...
					   <h3 class="section-margin-bottom text-white">GUDUVANCHERY</h3>
					   <div style="display: flex; align-items: center; justify-content:center; margin-bottom: 5px;">
						   <img src="{{asset('/resources/images-raack/icon-phone.png') }}" alt="Dance classes in Mylapore" class="img-fluid" style="width: 24px; height: 24px; margin-right: 10px;">
							<p><a href="tel:+919500919990" class="letter-spacing text-white">+91 9500919990</a> &nbsp; <a href="tel:+918754537733" class="letter-spacing text-white">+91 8754537733</a></p>
						</div>
						 <div style="display: flex; align-items: center; justify-content:center; margin-bottom: 5px;">
					...
					<iframe class="location-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1999333.6415081453!2d78.04155771576828!3d11.838877551989997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a52f78578a66dc7%3A0x78bdb9dd8e3f1344!2sRaack%20Academy%20of%20Dance%20%E2%80%93%20BEST%20DANCE%20CLASS%20%7C%20KIDS%20DANCE%20CLASS%20%7C%20ZUMBA%20CLASS%20%2F%20WESTERN%20DANCE%20CLASS%20IN%20GUDUVANCHERRY!5e0!3m2!1sen!2sin!4v1698990907802!5m2!1sen!2sin"></iframe>
				</div>
			</div>
         </div>
      </section>
                     ...
                     <div class="res-team-circle res-team-area-width res-width-team-area res-mar-right res-team-area-right">
                        <div class="our-team">
                           <div class="pic img-margin-bottom core-team-bg">
                              <img src="{{asset('/resources/images-raack/franchise-head/arun-kumar.png') }}" alt="Dance classes in Velachery" class="feature-circle-img img-fluid">
                           </div>
      ...
      <section class="section-dark-bg section-space animate-scroll gallery-slider"  data-animate="animate__animated animate__fadeInUp">
         ...
         <div class="container-fluid">
            <div id="logo-slider2" class="owl-carousel owl-theme " style="left: 50%; transform: translateX(-60%);">
               ...
               <div class="item text-center">
                  <img src="{{asset('/resources/images-raack/gallery/dance-classes-in-chennai.png') }}" alt="gallery-5" class="feature-circle-img img-fluid">
               </div>
               <div class="item text-center">
         ...
         <div class="container">
            ...
            <div class="row section-heading">
               ...
               <div class="col-lg-5 offset-1  res-left-mar0"> 
				  @include('forms.studios', array('studioName' => 'Guduvanchery'))
               </div>
            </div>
         </div>
      </section>
