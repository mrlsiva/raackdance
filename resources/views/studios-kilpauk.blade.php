...
@section('content') 
	...
	<!--================================= HEADER START ==========================================-->
      <section class="animate-scroll studio-bg-img" data-animate="animate__animated animate__fadeInUp" style="background-image: url({{asset('/resources/images-raack/studio-bg-image/Kilpauk.png') }}">
		   <div class="container">
			  <div class="text-right">
				 <h1 style="color: #ffffff;" class="font-weight400 rounded-box">KILPAUK</span></h1>
			  </div>
		   </div>
      </section>
      <!--================================= HEADER END ==========================================-->
      ...
      <section class="section-dark-bg studio-contact-bg studio-contact-bg section-space animate-scroll gallery-slider"  data-animate="animate__animated animate__fadeInUp">
         <div class="container">
			<div class="row">
				<div class="col-lg-7 mx-auto text-center">
					<div class="section-heading">
						<img src="{{asset('/resources/images-raack/logo.png') }}" alt="Dance classes in Thoraipakkam">
					   <h3 class="section-margin-bottom text-white">KILPAUK</h3>
					   <div style="display: flex; align-items: center; justify-content:center; margin-bottom: 5px;">
						   <img src="{{asset('/resources/images-raack/icon-phone.png') }}" alt="Dance classes in Mylapore" class="img-fluid" style="width: 24px; height: 24px; margin-right: 10px;">
							<p><a href="tel:+919543345345" class="letter-spacing text-white">+91 9543345345</a> &nbsp; <a href="tel:+919841429355" class="letter-spacing text-white">+91 9841429355</a></p>
						</div>
						 <div style="display: flex; align-items: center; justify-content:center; margin-bottom: 5px;">
					...
					<iframe class="location-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2826239.061461487!2d77.29709903625047!3d11.95870069707986!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a52642ef9b85445%3A0x9c32f806db88ed0!2sRaack%20Academy%20of%20Dance!5e0!3m2!1sen!2sin!4v1698912838466!5m2!1sen!2sin"></iframe>
				</div>
			</div>
         </div>
      </section>
         ...
         <div class="container">
            ...
            <div class="row section-heading">
               ...
               <div class="col-lg-5 offset-1  res-left-mar0"> 
					@include('forms.studios', array('studioName' => 'Kilpauk'))
               </div>
            </div>
         </div>
      </section>
