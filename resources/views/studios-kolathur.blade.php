...
@section('content') 
 ...
 <!--================================= HEADER START ==========================================-->
      <section class="animate-scroll studio-bg-img" data-animate="animate__animated animate__fadeInUp" style="background-image: url({{asset('/resources/images-raack/studio-bg-image/Kolathur.png') }}">
		   <div class="container">
			  <div class="text-right">
				 <h1 style="color: #ffffff;" class="font-weight400 rounded-box">KOLATHUR</span></h1>
			  </div>
		   </div>
      </section>
      <!--================================= HEADER END ==========================================-->
			...
			<div class="row">
				<div class="col-lg-7 mx-auto text-center">
					<div class="section-heading">
					   ...
					   <h3 class="section-margin-bottom text-white">KOLATHUR</h3>
					   <div style="display: flex; align-items: center; justify-content:center; margin-bottom: 5px;">
						   <img src="{{asset('/resources/images-raack/icon-phone.png') }}" alt="Dance classes in Mylapore" class="img-fluid" style="width: 24px; height: 24px; margin-right: 10px;">
							<p><a href="tel:+919841522220" class="letter-spacing text-white">+91 9841522220</a></p>
						</div>
						 <div style="display: flex; align-items: center; justify-content:center; margin-bottom: 5px;">
					...
					<iframe class="location-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1673246.4563632305!2d78.38425847558605!3d13.073842750945795!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5265ad1b7a87ab%3A0x6e14d7a0b9d2c60f!2sRaack%20Academy%20of%20Dance%20kolathur!5e0!3m2!1sen!2sin!4v1698992145025!5m2!1sen!2sin"></iframe>
				</div>
			</div>
         </div>
      </section>
      ...
      <!--=============================== STUDIOS AREA START =======================-->
      <section class="section-space section-white-bg animate-scroll" data-animate="animate__animated animate__fadeInUp"b style="padding-bottom: 0%;">
         <div class="container text-center">
            <div class="client-logo-slider">
               <img src="{{asset('/resources/images-raack/Ascent-Short.png') }}" alt="Ascent-Short" class="img-fluid team-ul-img animate-scroll" data-animate="animate__animated animate__zoomIn">
                           ...
                           <div class="res-team-circle res-team-area-width res-width-team-area res-mar-right res-team-area-right">
                              <div class="our-team">
                                  <div class="pic img-margin-bottom core-team-bg">
                                      <img src="{{asset('/resources/images-raack/franchise-head/smitha.png') }}" alt="Dance classes in Velachery" class="feature-circle-img img-fluid">
                                  </div>
                  ...
                  <div class="col-lg-3">
                     <div class="item text-center res-text-center">
                        <div class="res-team-circle res-team-area-width res-width-team-area res-mar-right res-team-area-right">
                           <div class="our-team">
                               <div class="pic img-margin-bottom core-team-bg">
                                   <img src="{{asset('/resources/images-raack/franchise-head/supra.png') }}" alt="Dance classes in Neelankarai" class="feature-circle-img img-fluid">
                               </div>
                               <button class="primary-btn"> 
										   Supra Karthikeyan
                               </button>
         ...
         <div class="container">
            ...
            <div class="row section-heading">
               ...
               <div class="col-lg-5 offset-1  res-left-mar0"> 
				  @include('forms.studios', array('studioName' => 'Kolathur'))
               </div>
            </div>
         </div>
      </section>
