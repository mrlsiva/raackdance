...
@section('content') 
	...
	<!--================================= HEADER START ==========================================-->
      <section class="animate-scroll studio-bg-img" data-animate="animate__animated animate__fadeInUp" style="background-image: url({{asset('/resources/images-raack/studio-bg-image/Mylapore.png') }}">
		   <div class="container">
			  <div class="text-right">
				 <h1 style="color: #ffffff;" class="font-weight400 rounded-box">MYLAPORE</span></h1>
			  </div>
		   </div>
      </section>
      <!--================================= HEADER END ==========================================-->
			...
			<div class="row">
				<div class="col-lg-7 mx-auto text-center">
					<div class="section-heading">
						<img src="{{asset('/resources/images-raack/logo.png') }}" alt="Dance academy in Chennai">
					   <h3 class="section-margin-bottom text-white">MYLAPORE</h3>
					   <div style="display: flex; align-items: center; justify-content:center; margin-bottom: 5px;">
						   <img src="{{asset('/resources/images-raack/icon-phone.png') }}" alt="Dance classes in Thoraipakkam" class="img-fluid" style="width: 24px; height: 24px; margin-right: 10px;">
							<p><a href="tel:+919543345345 " class="letter-spacing text-white">+91 95433 45345 </a> &nbsp; <a href="tel:+919841429355" class="letter-spacing text-white">+91 9841429355</a></p>
						</div>
						 <div style="display: flex; align-items: center; justify-content:center; margin-bottom: 5px;">
						   <img src="{{asset('/resources/images-raack/icon-mail.png') }}" alt="Dance classes in Mylapore" class="img-fluid" style="width: 24px; height: 24px; margin-right: 10px;">
							<p><a href="mailto:enquiry@raack.com" class="text-white">enquiry@raack.com</a></p>
						</div>
					</div>
					<iframe class="location-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d418691.41486325354!2d79.83710953699435!3d12.847913958730533!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5267d247a51bad%3A0x95d966da5409dcae!2sRaack%20Academy%20Of%20Dance!5e0!3m2!1sen!2sin!4v1698922543186!5m2!1sen!2sin"></iframe>
            </div>
			</div>
         </div>
      </section>
      ...
      <section class="section-space section-white-bg animate-scroll" data-animate="animate__animated animate__fadeInUp">
         <div class="container">
			<div class="section-heading">
               ...
               <img src="{{asset('/resources/images-raack/gallery/arrow.png') }}" alt="Dance classes in Kolathur" class="img-fluid gallery-ul float-right res-bot10" >
            </div>
            <div class="row section-heading">
               ...
               <div class="col-lg-5 offset-1  res-left-mar0"> 
					@include('forms.studios', array('studioName' => 'Mylapore'))
               </div>
            </div>
         </div>
      </section>
