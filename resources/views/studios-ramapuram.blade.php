...
@section('content') 
 ...
 <!--================================= HEADER START ==========================================-->
      <section class="animate-scroll studio-bg-img" data-animate="animate__animated animate__fadeInUp" style="background-image: url({{asset('/resources/images-raack/studio-bg-image/Ramapuram.png') }}">
		   <div class="container">
			  <div class="text-right">
				 <h1 style="color: #ffffff;" class="font-weight400 rounded-box">RAMAPURAM</span></h1>
			  </div>
		   </div>
      </section>
      <!--================================= HEADER END ==========================================-->
			...
			<div class="row">
				<div class="col-lg-7 mx-auto text-center">
					<div class="section-heading">
					   ...
					   <h3 class="section-margin-bottom text-white">RAMAPURAM</h3>
					   <div style="display: flex; align-items: center; justify-content:center; margin-bottom: 5px;">
						   <img src="{{asset('/resources/images-raack/icon-phone.png') }}" alt="Dance classes in Mylapore" class="img-fluid" style="width: 24px; height: 24px; margin-right: 10px;">
							<p><a href="tel:+916379671663" class="letter-spacing text-white">+91 6379671663</a></p>
						</div>
						 <div style="display: flex; align-items: center; justify-content:center; margin-bottom: 5px;">
					...
					<iframe class="location-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1992397.1590518598!2d78.10231796326009!3d12.752469623376212!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a526100b3e70c15%3A0xc5f8c324c4917826!2sRAACK%20ACADEMY%20OF%20DANCE%20-%20BEST%20DANCE%20CLASS%20%2F%20KIDS%20DANCE%20CLASS%20%2F%20HIGH%20STAR%20RATED%20DANCE%20CLASS%20%2F%20ZUMBA%20FITNESS%20CLASS%20IN%20RAMAPURAM!5e0!3m2!1sen!2sin!4v1698994562098!5m2!1sen!2sin"></iframe>
				</div>
			</div>
         </div>
      </section>
                  ...
                  <div class="res-team-circle res-team-area-width res-width-team-area res-mar-right res-team-area-right">
                     <div class="our-team">
                        <div class="pic img-margin-bottom core-team-bg">
                           <img src="{{asset('/resources/images-raack/franchise-head/pradeep.png') }}" alt="Dance classes in Velachery" class="feature-circle-img img-fluid">
                        </div>
                        ...
                        <tr>
                           ...
                           <td style="border-bottom-width: 1px;"> 
                              <div class="item">
                                 ...
                                 <div class="title">
                                    <h5><a href="#">CHOREO LAB Teens</a></h5>
                                 </div>
                              </div>
                           </td>
         ...
         <div class="container">
            ...
            <div class="row section-heading">
               ...
               <div class="col-lg-5 offset-1  res-left-mar0"> 
				  @include('forms.studios', array('studioName' => 'Ramapuram'))
               </div>
            </div>
         </div>
      </section>
