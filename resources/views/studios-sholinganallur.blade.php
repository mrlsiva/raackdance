...
@section('content') 
 ...
 <!--================================= HEADER START ==========================================-->
      <section class="animate-scroll studio-bg-img" data-animate="animate__animated animate__fadeInUp" style="background-image: url({{asset('/resources/images-raack/studio-bg-image/Sholinganallur.png') }}">
		   <div class="container">
			  <div class="text-right">
				 <h1 style="color: #ffffff;" class="font-weight400 rounded-box">SHOLINGANALLUR</span></h1>
			  </div>
		   </div>
      </section>
      <!--================================= HEADER END ==========================================-->
			...
			<div class="row">
				<div class="col-lg-7 mx-auto text-center">
					<div class="section-heading">
					   ...
					   <h3 class="section-margin-bottom text-white">SHOLIGANALLUR</h3>
					   <div style="display: flex; align-items: center; justify-content:center; margin-bottom: 5px;">
						   <img src="{{asset('/resources/images-raack/icon-phone.png') }}" alt="Dance classes in Mylapore" class="img-fluid" style="width: 24px; height: 24px; margin-right: 10px;">
							<p><a href="tel:+919884822231" class="letter-spacing text-white">+91 9884822231</a> &nbsp; <a href="tel:+919841429355" class="letter-spacing text-white">+91 9841429355</a></p>
						</div>
						 <div style="display: flex; align-items: center; justify-content:center; margin-bottom: 5px;">
					...
					<iframe class="location-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1999161.5670218705!2d78.11939947066305!3d11.862379194347623!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a525bfe97a94a57%3A0x9a1287bb0b46ea88!2sRaack%20Academy%20of%20Dance!5e0!3m2!1sen!2sin!4v1698995147474!5m2!1sen!2sin"></iframe>
				</div>
			</div>
         </div>
      </section>
                  ...
                  <div class="res-team-circle res-team-area-width res-width-team-area res-mar-right res-team-area-right">
                     <div class="our-team">
                        <div class="pic img-margin-bottom core-team-bg">
                           <img src="{{asset('/resources/images-raack/franchise-head/rajiv.png') }}" alt="Dance classes in Velachery" class="feature-circle-img img-fluid">
                        </div>
                        ...
                        <tr>
                           ...
                           <td style="border-bottom-width: 1px;">
                              <div class="item">                                  
                                 ...
                                 <div class="title">
                                    <h5><a href="#">CHOREO LAB (7 to 12yrs)</a></h5>
                                 </div>
                              </div>
                           </td>
      ...
      <section class="section-dark-bg section-space animate-scroll gallery-slider"  data-animate="animate__animated animate__fadeInUp">
         <div class="container">
            <div class="section-heading">
               <h3 class="section-margin-bottom text-white">SHOLINGANALLUR</h3>
               <img src="{{asset('/resources/images-raack/gallery/arrow.png') }}" alt="Dance classes in Neelankarai" class="img-fluid gallery-ul float-right res-bot10" >
            </div>
         </div>
         <div class="container-fluid" style="overflow: hidden;">
            <div id="logo-slider" class="owl-carousel owl-theme " style="right: 50%; transform: translateX(56%); opacity: 1; display: block;">
               <div class="item text-center">
                  <img src="{{asset('/resources/images-raack/gallery/dance-classes-in-chennai.png') }}" alt="Dance classes in Ramapuram" class="feature-circle-img img-fluid">
               </div>
               <div class="item text-center">
                  <img src="{{asset('/resources/images-raack/gallery/dance-academy-in-chennai.png') }}" alt="Dance classes in saidapet" class="feature-circle-img img-fluid">
               </div>
               <div class="item text-center">
                  <img src="{{asset('/resources/images-raack/gallery/dance-classes-for-kids-in-chennai.png') }}" alt="Dance classes in Avadi" class="feature-circle-img img-fluid">
               </div>
               <div class="item text-center">
                  <img src="{{asset('/resources/images-raack/gallery/dance-classes-for-adults-in-chennai.png') }}" alt="Dance classes in Mogappair" class="feature-circle-img img-fluid">
               </div>
               <div class="item text-center">
         ...
         <div class="container-fluid">
            <div id="logo-slider2" class="owl-carousel owl-theme " style="left: 50%; transform: translateX(-60%);">
               <div class="item text-center">
                  <img src="{{asset('/resources/images-raack/gallery/dance-classes-in-chennai.png') }}" alt="Dance classes in Mugalivakkam" class="feature-circle-img img-fluid">
               </div>
               <div class="item text-center">
                  <img src="{{asset('/resources/images-raack/gallery/dance-academy-in-chennai.png') }}" alt="Dance classes in Keelkatalai" class="feature-circle-img img-fluid">
               </div>
               <div class="item text-center">
                  <img src="{{asset('/resources/images-raack/gallery/dance-classes-for-kids-in-chennai.png') }}" alt="Dance classes in sholinganallur" class="feature-circle-img img-fluid">
               </div>
               <div class="item text-center">
                  <img src="{{asset('/resources/images-raack/gallery/dance-classes-for-adults-in-chennai.png') }}" alt="Dance classes in Pallikaranai" class="feature-circle-img img-fluid">
               </div>
               <div class="item text-center">
                  <img src="{{asset('/resources/images-raack/gallery/dance-classes-in-chennai.png') }}" alt="Dance classes in Kolathur" class="feature-circle-img img-fluid">
               </div>
               <div class="item text-center">
                  <img src="{{asset('/resources/images-raack/gallery/dance-academy-in-chennai.png') }}" alt="Dance classes in Guduvanchery" class="feature-circle-img img-fluid">
               </div>
            </div>
         </div>
      </section>
      ...
      <section class="section-space section-white-bg animate-scroll" data-animate="animate__animated animate__fadeInUp">
         <div class="container">
			<div class="section-heading">
               ...
               <img src="{{asset('/resources/images-raack/gallery/arrow.png') }}" alt="Dance classes for adults Chennai" class="img-fluid gallery-ul float-right res-bot10" >
            </div>
            <div class="row section-heading">
               ...
               <div class="col-lg-5 offset-1  res-left-mar0"> 
				  @include('forms.studios', array('studioName' => 'Sholinganallur'))
               </div>
            </div>
         </div>
      </section>
