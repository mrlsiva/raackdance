...
@section('content') 
	...
	<!--================================= HEADER START ==========================================-->
      <section class="animate-scroll studio-bg-img" data-animate="animate__animated animate__fadeInUp" style="background-image: url({{asset('/resources/images-raack/studio-bg-image/Tambaram.png') }}">
         <div class="container" style="position: relative; z-index: 1;">
            <div class="text-right">
               <h1 style="color: #ffffff;" class="font-weight400 rounded-box">TAMBARAM</h1>
            </div>
         </div>
      </section>
      <!--================================= HEADER END ==========================================-->
			...
			<div class="row">
				<div class="col-lg-7 mx-auto text-center">
					<div class="section-heading">
					   ...
					   <h3 class="section-margin-bottom text-white">TAMBARAM</h3>
					   <div style="display: flex; align-items: center; justify-content:center; margin-bottom: 5px;">
						   <img src="{{asset('/resources/images-raack/icon-phone.png') }}" alt="Dance classes in Mylapore" class="img-fluid" style="width: 24px; height: 24px; margin-right: 10px;">
							<p><a href="tel:+917845055523" class="letter-spacing text-white">+91 7845055523</a> &nbsp; <a href="tel+919962609365" class="letter-spacing text-white">+91 9962609365</a></p>
						</div>
						 <div style="display: flex; align-items: center; justify-content:center; margin-bottom: 5px;">
					...
					<iframe class="location-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d124440.13084499339!2d80.06033954266958!3d12.923520583392289!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a525f1e01e681fd%3A0x9959a48681c42af5!2sRAACK%20Academy%20Of%20Dance!5e0!3m2!1sen!2sin!4v1698995630086!5m2!1sen!2sin"></iframe>
				</div>
			</div>
         </div>
      </section>
                  ...
                  <div class="res-team-circle res-team-area-width res-width-team-area res-mar-right res-team-area-right">
                     <div class="our-team">
                        <div class="pic img-margin-bottom core-team-bg">
                           <img src="{{asset('/resources/images-raack/core-team/Kavi-chakravarthi.png') }}" alt="Dance classes in Velachery" class="feature-circle-img img-fluid">
                        </div>
         ...
         <div class="container">
            ...
            <div class="row section-heading">
               ...
               <div class="col-lg-5 offset-1  res-left-mar0"> 
					@include('forms.studios', array('studioName' => 'Tambaram'))
               </div>
            </div>
         </div>
      </section>
