...
@section('content') 
	 ...
	 <!--================================= HEADER START ==========================================-->
      <section class="animate-scroll studio-bg-img" data-animate="animate__animated animate__fadeInUp" style="background-image: url({{asset('/resources/images-raack/studio-bg-image/Thoraipakkam.png') }}">
		   <div class="container">
			  <div class="text-right">
				 <h1 style="color: #ffffff;" class="font-weight400 rounded-box">THORAIPAKKAM</span></h1>
			  </div>
		   </div>
      </section>
      <!--================================= HEADER END ==========================================-->
			...
			<div class="row">
				<div class="col-lg-7 mx-auto text-center">
					<div class="section-heading">
						<img src="{{asset('/resources/images-raack/logo.png') }}" alt="Dance classes in Mylapore">
					   <h3 class="section-margin-bottom text-white">THORAIPAKKAM</h3>
					   <div style="display: flex; align-items: center; justify-content:center; margin-bottom: 5px;">
						   <img src="{{asset('/resources/images-raack/icon-phone.png') }}" alt="Dance classes in old perungalathur" class="img-fluid" style="width: 24px; height: 24px; margin-right: 10px;">
							<p><a href="tel:+918778437344" class="letter-spacing text-white">+91 8778437344</a></p>
						</div>
						 <div style="display: flex; align-items: center; justify-content:center; margin-bottom: 5px;">
						   <img src="{{asset('/resources/images-raack/icon-mail.png') }}" alt="Dance classes in Velachery" class="img-fluid" style="width: 24px; height: 24px; margin-right: 10px;">
							<p><a href="mailto:enquiry@raack.com" class="text-white">enquiry@raack.com</a></p>
						</div>
					</div>
					<iframe class="location-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1998928.616258047!2d78.12153848034818!3d11.894122288449553!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a525d012d3cd28f%3A0x8be2fec697e6c00c!2sRaack%20Academy%20of%20Dance!5e0!3m2!1sen!2sin!4v1698995789461!5m2!1sen!2sin"></iframe>
				</div>
			</div>
         </div>
      </section>
                  ...
                  <div class="res-team-circle res-team-area-width res-width-team-area res-mar-right res-team-area-right">
                     <div class="our-team">
                        <div class="pic img-margin-bottom core-team-bg">
                           <img src="{{asset('/resources/images-raack/franchise-head/anthony_raja.png') }}" alt="Dance classes in Neelankarai" class="feature-circle-img img-fluid">
                        </div>
                              ...
                              <tr>
                                 ...
                                 <td style="border-bottom-width: 1px;">
                                    <div class="item">                                  
                                       ...
                                       <div class="title">
                                          <h5><a href="#">FILM COVERS -TEENS</a></h5>
                                       </div>
                                    </div>
                                 </td>
         ...
         <div class="container">
            ...
            <div class="row section-heading">
               ...
               <div class="col-lg-5 offset-1  res-left-mar0"> 
                  @include('forms.studios', array('studioName' => 'Thoraipakkam'))				  
               </div>
            </div>
         </div>
      </section>
